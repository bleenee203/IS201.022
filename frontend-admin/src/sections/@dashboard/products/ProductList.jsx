...
// sections
import { ProductListHead, ProductModal } from "~/sections/@dashboard/products";
// mock
...
const TABLE_HEAD = [
  ...
  { id: "category", label: "Loại/Giống", alignRight: false },
...
export default function ProductList() {
  ...
  return (
    <>
                      ...
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <Avatar alt={name} src={avatarUrl} variant="square" />
                        ...
                        <TableCell align="left">{valueLabelFormat(1000000)}</TableCell>
      ...
      <ProductModal open={openModal} setOpen={setOpenModal} id={selectId}/>
    </>
  );
}
